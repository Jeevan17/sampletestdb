			...
			<form action='AEC.php' method='POST' enctype='multipart/form-data'>
				<table>
					<tr>
						...
						<td style='padding: 10px;font-size: 20px;'><input type='text' name='rollno' class='log_text2'></td>
					</tr>
					<tr>
						<th style='padding: 5px;font-size: 20px;'>Admission No </th>
						<td style='padding: 10px;font-size: 20px;'><input type='text' name='adminno'  class='log_text2'></td>
					</tr>
					<tr>
						<th style='padding: 5px;font-size: 20px;'>First Name </th>
						<td style='padding: 10px;font-size: 20px;'><input type='text' name='Fname' class='log_text2'></td>
					</tr>
					<tr>
						<th style='padding: 5px;font-size: 20px;'>Last Name </th>
						<td style='padding: 10px;font-size: 20px;'><input type='text' name='Lname' class='log_text2'></td>
					</tr>
					<tr>
						<th style='padding: 5px;font-size: 20px;'>Father Name </th>
						<td style='padding: 10px;font-size: 20px;'><input type='text' name='fatherN' class='log_text2'></td>
					</tr>
					<tr>
						<th style='padding: 5px;font-size: 20px;'>Phone No </th>
						<td style='padding: 10px;font-size: 20px;'><input type='text' name='phno' class='log_text2'></td>
					</tr>
					<tr>
						<th style='padding: 5px;font-size: 20px;'>Address</th>
						<td style='padding: 10px;font-size: 20px;'><textarea rows= '4' cols='16' name='address'  style='font-size:20px; width:300px; height:75px; padding-left: 10px;'></textarea></td>
					</tr>
					<tr>
						<th style='padding: 5px;font-size: 20px;'>Graduation</th>
						<td style='padding: 10px;font-size: 20px;'>
							<select name='graduation' required class='log_text2'>
					...
					<tr>
						...
						<td style='padding: 10px;font-size: 20px;'>
							<select name='branch' required class='log_text2'>
					...
					<tr>
						...
						<td style='padding: 10px;font-size: 20px;'><input type='text' name='Fphno' class='log_text2'></td>
					</tr>
					<tr>
						<th style='padding: 5px;font-size: 20px;'>Email ID</th>
						<td style='padding: 10px;font-size: 20px;'><input type='email' name='email' class='log_text2'></td>
					</tr>
					<tr>
						<th style='padding: 5px;font-size: 20px;'>Date of Joining</th>
						<td style='padding: 10px;font-size: 20px;'><input type='date' name='doj' class='log_text2'></td>
					</tr>
					<tr>
						<th style='padding: 5px;font-size: 20px;'>Photo</th>
						<td style='padding: 10px;font-size: 20px;'><input type='file' name='img' class='log_text2'></td>
					</tr>
				</table>
				<br>
				<br>
			...
			<form action='AEC.php' method='POST'>
				<table>
					...
					<tr>
						...
						<td style='padding: 10px;font-size: 20px;'><input type='text' name='cid' class='log_text2'></td>
					</tr>
					<tr>
						<th style='padding: 5px;font-size: 20px;'>Branch</th>
						<td style='padding: 10px;font-size: 20px;'>
					...
					<tr>
						...
						<td style='padding: 10px;font-size: 20px;'><input type='text' name='attendance' class='log_text2'></td>
					</tr>
				</table>
				<br><br>
